...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    linkedin: 'https://linkedin.com/in/shreyas-scoders',
    github: 'https://github.com/shreyas-scoders',
  ...
  },
  {
    ...
    bio: 'Lead backend engineer and AI system specialist directing server architectures, real-time database synchronizations, and robust cloud microservices.',
    expertise: ['Node.js & Express', 'PostgreSQL & Cloud SQL', 'AI System Integration', 'Distributed Systems', 'API Security'],
    linkedin: 'https://linkedin.com/in/bhuvan-scoders',
    github: 'https://github.com/bhuvan-scoders',
    contribution: 'Architects server-side APIs, database systems, real-time communications, and secure payment processing infrastructure.',
  },
  {
    id: '4',
    name: 'Prathiksha R',
