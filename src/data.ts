...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: 'Founder and CEO of S-CODERS (Bharat Tech Developers). AI Engineer, Full-Stack Developer, and Digital Creator dedicated to transforming ideas into scalable, user-friendly digital products and AI automation systems.',
    expertise: ['AI & AI Agents', 'Full-Stack Development', 'React Native & Flutter', 'Python & Django', 'Workflow Automation (n8n)', 'Secure Systems', 'SaaS & Web Apps'],
    linkedin: 'https://www.linkedin.com/in/shreyas-shreyas-97187638b?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    github: 'https://github.com/shreyasshreyas40858-max/Chaturya',
    contribution: 'Steers company vision, architects AI agent pipelines, builds cross-platform mobile apps & web platforms, and leads product innovation at Bharat Tech Developers.',
  },
  {
    id: '2',
    name: 'Lokesh A.',
    ...
    bio: 'Co-Founder of S-CODERS (Bharat Tech Developers). Vibe Coder, AI-Assisted Developer, Real-World Project Builder, and Digital Creator turning concepts into working websites, applications, and smart automation systems.',
    expertise: ['AI-Assisted Development', 'Vibe Coding', 'Rapid Prototyping', 'Real-World Apps', 'Smart Workflows', 'Digital Creativity', 'Product Building'],
    linkedin: 'https://linkedin.com/in/lokesh-scoders',
    github: 'https://github.com/lokesh-scoders',
    contribution: 'Drives rapid prototyping, AI-assisted development workflows, project execution, and practical digital product delivery at Bharat Tech Developers.',
  },
  {
    id: '3',
    name: 'Bhuvan M.',
    role: 'Tech Lead — S-CODERS',
    photoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=300&h=300',
    bio: 'Tech Lead at S-CODERS, Full-Stack Developer, Web Developer, UI/UX Enthusiast, and Digital Product Builder. Solely designed and developed the entire S-CODERS digital platform.',
    expertise: ['Full-Stack Web Development', 'Modern Website Architecture', 'UI/UX & Interactive Design', 'Responsive Web Applications', 'AI-Assisted Development', 'Digital Product Building'],
    linkedin: '',
    github: '',
    contribution: 'Complete design and development of the S-CODERS website, full-stack platform architecture, UI/UX interaction systems, and digital product execution.',
  },
  {
    id: '4',
    name: 'Prathiksha R',
  ...
  },
  {
    ...
    contribution: 'Architects reliable database schemas, manages API endpoints, integrates payments, and programs high-performance mobile apps.',
  },
  {
    id: '6',
    ...
    expertise: ['n8n Integration', 'Zapier', 'Digital Marketing', 'Technical Training', 'Community Growth'],
    linkedin: 'https://linkedin.com/in/aishwarya-scoders',
    github: 'https://github.com/aishwarya-scoders',
    contribution: 'Leads our regional tech workshops, curates community educational sessions, builds custom automation bots, and executes S-CODERS digital presence.',
  },
];
