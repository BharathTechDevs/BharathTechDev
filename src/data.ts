...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: 'AI Engineer, Full-Stack Developer, and Product Visionary. Oversees company strategy, architects AI agent pipelines, builds cross-platform mobile apps, and leads product innovation at Bharat Tech Developers.',
    expertise: ['AI Engineering', 'Full-Stack Development', 'React Native', 'LLM Agents', 'Automation'],
    ...
    github: 'https://github.com/Shreyas-73',
    email: 'scoders82@gmail.com',
    contribution: 'Strategic direction, AI agent architectures, mobile apps, and enterprise operations.',
  },
  {
    id: '2',
    name: 'Lokesh A.',
    ...
    bio: 'Vibe Coder, AI-assisted developer, and rapid prototyping specialist. Focuses on turning ideas into functional software, smart automations, and practical digital products.',
    expertise: ['Vibe Coding', 'AI Prototyping', 'Prompt Engineering', 'Product Strategy', 'Workflow Automation'],
    linkedin: 'https://www.linkedin.com/in/lokesh-a-62b217316?utm_source=share_via&utm_content=profile&utm_medium=android_app',
    github: 'https://github.com/Lokesh132005',
    email: 'scoders82@gmail.com',
    contribution: 'Rapid AI prototyping, smart workflow automations, and digital product innovation.',
  },
  {
    id: '3',
    name: 'Bhuvan M.',
    ...
    linkedin: 'https://www.linkedin.com/in/bhuvan-m-102835326/',
    github: 'https://github.com/Gowda487',
    email: 'scoders82@gmail.com',
    contribution: 'End-to-end design & engineering of the S-CODERS web platform, user interfaces, and technical systems.',
  },
];
...
export const INITIAL_COMMENTS = [
  ...
  },
  {
    ...
    role: 'SaaS Founder',
    content: 'Super practical! The walkthrough on building custom WhatsApp bots for automated lead capture saved us weeks of research. Shreyas is an incredible mentor.',
  ...
  },
  {
    ...
    content: 'Shreyas and Bhuvan made React Native and UI architecture feel so easy. The animations section was particularly top-notch. Can\'t wait for their next bootcamp!',
