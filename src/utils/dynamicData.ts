...
const DEFAULT_NETWORKING_ACHIEVEMENTS: NetworkingAchievement[] = [
  {
    ...
    description: 'Shreyas M. demonstrating autonomous AI pipelines using the Gemini 3.5 Flash model during our weekly developers breakout session.',
  ...
  },
  {
    ...
    description: 'Our co-founder Lokesh A. engaging in an immersive panel Q&A session regarding SaaS scaling architectures in South Asia.',
  ...
  },
  {
    ...
    description: 'Bhuvan M. guiding over 80+ builders to automate their marketing funnels using S-CODERS custom presets.',
  ...
  },
  {
    ...
    description: 'Shreyas M. presenting our custom-built client-ready multi-agent pipeline to early-stage SaaS angel investors.',
